    ...
    <div className="space-y-0">
      ...
      <section className="relative min-h-[100vh] md:min-h-[90vh] flex items-center py-20 md:py-0">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center w-full">
          ...
          <p className="text-base sm:text-lg md:text-xl text-primary-foreground/80 mb-4 md:mb-6 max-w-4xl mx-auto leading-relaxed px-4">
            HerShield is an immigrant women-led movement rooted in compassion, courage, and collective power. We exist
            to create a ripple effect of empowerment — connecting women who rise, heal, and give back together.
          </p>
          <p className="text-base sm:text-lg md:text-xl text-primary-foreground/80 mb-4 md:mb-6 max-w-4xl mx-auto leading-relaxed px-4">
            Every four months, we unite behind a new cause through our Quarterly Impact Partnerships — amplifying
            voices, raising awareness, and mobilizing resources to build stronger, more equitable futures for women and
            communities in need.
          </p>
          <p className="text-base sm:text-lg md:text-xl text-primary-foreground/80 mb-6 md:mb-8 max-w-4xl mx-auto leading-relaxed px-4">
            At HerShield, we believe that when women come together, change becomes inevitable. We are not just building
            support — we're building legacy, leadership, and sisterhood.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button variant="hero" size="lg" onClick={() => window.open("/get-involved", "_self")}>
              Get Involved
      ...
      <section className="py-12 md:py-20" style={{ backgroundColor: "hsl(var(--light-orange))" }}>
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          <blockquote
            className="text-xl sm:text-2xl md:text-3xl font-medium italic mb-4 md:mb-6 leading-relaxed"
            style={{ color: "hsl(var(--crimson))" }}
          >
            "HerShield is my promise to every woman: you are not alone. Together, we are stronger, braver, and
            unstoppable."
          </blockquote>
            ...
            <Card className="shadow-medium hover:shadow-strong transition-smooth max-w-md w-full">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg" style={{ color: "hsl(var(--crimson))" }}>
                      Polished by HerShield
                    </h3>
                    <p className="text-sm text-muted-foreground">November 23, 2025</p>
                  </div>
                </div>
                <p className="text-muted-foreground mb-4">
                  Join us for an exclusive evening of empowerment, connection, and celebration as we unite women leaders
                  and changemakers.
                </p>
                <Button
                  variant="cta"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-6" style={{ color: "hsl(var(--gray-brown))" }}>
                This quarter, we're partnering with the Women's Emergency Shelter Network to provide safe housing and
                support services for women and children escaping domestic violence. Every donation goes directly to
                providing shelter, counseling, and job training programs.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button variant="outline" size="lg" onClick={() => window.open("/charity", "_self")}>
                  Learn More
                </Button>
              </div>
            </div>
            ...
            <Card className="shadow-strong">
              <CardContent className="p-8">
                <div className="text-center">
                  ...
                  <h4 className="text-2xl font-bold mb-2" style={{ color: "hsl(var(--crimson))" }}>
                    100% Transparency
                  </h4>
                  <p className="text-muted-foreground mb-4">
                    Every dollar donated goes directly to our partner charity. We cover all administrative costs
                    separately.
                  </p>
                  <div className="text-3xl font-bold gradient-primary bg-clip-text text-transparent mb-2">$15,000</div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-strong">
            ...
            <div className="absolute bottom-8 left-8 right-8 text-center">
              <h3 className="text-2xl font-bold text-primary-foreground mb-2">Join Our Growing Community</h3>
              <p className="text-primary-foreground/90 mb-4">Over 500 women connected and empowered</p>
              <Button variant="hero" size="lg" onClick={() => window.open("/get-involved", "_self")}>
