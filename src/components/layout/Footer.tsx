        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mb-4 max-w-md" style={{ color: "hsl(var(--gray-brown))" }}>
              Elevating women through unity and support. A South Asian women-led initiative empowering women and giving
              back through quarterly charity partnerships.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-lg mb-4" style={{ color: "hsl(var(--crimson))" }}>
              Quick Links
            </h3>
          ...
          <div>
            ...
            <div className="space-y-2">
              <p style={{ color: "hsl(var(--gray-brown))" }}>
                <a
                  href="mailto:collaborate@hershieldnetwork.ca "
                  className="hover:opacity-80 transition-smooth"
                  style={{ color: "hsl(var(--gray-brown))" }}
                >
                  collaborate@hershieldnetwork.ca
                </a>
              </p>
              <p style={{ color: "hsl(var(--gray-brown))" }}>Building stronger futures together</p>
            </div>
          </div>
        </div>
